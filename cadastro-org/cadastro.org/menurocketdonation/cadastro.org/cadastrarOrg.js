...
form.addEventListener('submit', (event) => {
    ...
    let organizacao = {
                nomeOrg: document.getElementById('nomeOrg').value,
                emailOrg: document.getElementById('emailOrg').value,
                siteOrg: document.getElementById('site').value,
                categoriaOrg: document.getElementById('categoria').value,
                cep: document.getElementById('cep').value,
                rua: document.getElementById('rua').value,
                numero: document.getElementById('numero').value,
                complemento: document.getElementById('complemento').value,
                ...
                numeroConta: document.getElementById('numeroConta').value,
                chavePix: document.getElementById('chavePix').value,
                telefoneOrg: document.getElementById('telefone').value,
                missaoOrg: document.getElementById('missao').value
            };
    saveAPI(organizacao);
